...
def manifest():
    return json.loads((ROOT/"audit/COMPANYOS_V67_4_LEGACY_BATCH2_MANIFEST.json").read_text())
...
def test_batch_is_recoverable_and_zero_reference():
    ...
    assert d["recovery_branch"].startswith("recovery/v67.4-pre-legacy-batch2-")
