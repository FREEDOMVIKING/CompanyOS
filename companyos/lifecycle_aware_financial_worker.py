...
def process_lifecycle_once(max_items: int = 5):
    ...
    summary = {
        ...
        "deferred_retry": 0,
        "skipped_claimed": 0,
        "mode": os.getenv("COMPANYOS_AUTONOMOUS_FINANCIAL_MODE", "dry_run").strip().lower(),
        "last_error": None,
    }
