...
RUN=HOME/".companyos_enterprise_v13"
...
def main():
    ...
    while not STOP.exists():
        if child is None or child.poll() is not None:
            ...
            log=open(RUN/"v13.log","ab",buffering=0)
            child=subprocess.Popen([sys.executable,"-u","-m","companyos.autonomous_company_builder_v13.server"],
