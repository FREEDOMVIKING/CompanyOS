...
def main():
    ...
    p.add_argument("--interval",type=int,default=int(os.environ.get("COMPANYOS_INTELLIGENCE_INTERVAL","60")))
    a=p.parse_args()
    ...
    while RUNNING:
        try:
            ...
            print(json.dumps({
                ...
                "portfolio_score":r["portfolio"]["score"],
                "opportunities":len(r["opportunities"]),
                "playbooks":len(r["playbooks"]),
            }),flush=True)
        except Exception as e:
            print(json.dumps({"intelligence_error":str(e)}),flush=True)
