...
class ProductionExecutionCoordinator:
    ...
    def execute(
        ...
        *,
        ...
        if request.action_type not in {"zero_lamport_self_transfer", "sol_transfer"}:
        ...
        if request.action_type == "zero_lamport_self_transfer" and request.amount_lamports != 0:
            return ProductionExecutionResponse(
        ...
        if request.action_type == "zero_lamport_self_transfer" and request.destination != self.engine.wallet_address:
            return ProductionExecutionResponse(
        ...
        if request.action_type == "zero_lamport_self_transfer":
            ...
            result: LiveExecutionResult = self.engine.execute_sol_transfer(
