...
class SolanaExecutionGate:
    def __init__(self, root, allowlist=None, policy=None):
        ...
        self.pending_recovery = PendingTransactionRecovery(root)
    ...
    def prepare_and_execute(
        ...
        *,
        ...
        if decision["decision"] == "blocked":
            ...
            # Phase 66 V2 pending recovery hook: persistence only, never rebroadcast.
        ...
        if verification["passed"]:
            execution_status = "verified_onchain_execution"
        elif verification_state == "pending":
            execution_status = "execution_pending_confirmation"
        elif verification_state == "failed":
            execution_status = "execution_failed_onchain"
        else:
        ...
        out = {
            ...
            "confirmation_state": verification.get("state"),
            "verification": verification,
            "receipt": receipt,
        }
        self.idempotency.put(idempotency_key, out)
