class MarketOpsGuardrails:
    GATED={
        "send_external_email","publish_public_content","production_deploy","bank_transfer",
        "contract_signature","large_marketing_spend","hire_employee","borrow_money",
        "legal_filing","acquisition","delete_external_resource"
    }
