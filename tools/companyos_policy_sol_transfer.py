...
ap = argparse.ArgumentParser(description="CompanyOS policy-controlled SOL transfer")
...
result = gateway.execute(
    ...
    allow_broadcast=bool(args.broadcast),
    confirm_token=args.confirm_token,
    idempotency_key=args.idempotency_key or f"policy-cli-{uuid.uuid4()}",
    source=args.source,
)

print("=== COMPANYOS EXECUTION POLICY GATEWAY ===")
print("MODE:", "LIVE" if args.broadcast else "DRY RUN")
print("DESTINATION:", args.destination)
print("AMOUNT SOL:", args.sol)
print("SINGLE CAP SOL:", single_cap)
print("DAILY CAP SOL:", daily_cap)
print("RESERVE SOL:", reserve)
...
print("AUDIT LEDGER:", str(ledger.root))
